...
_.assignIn(PostmanCLIReporter, {
    ...
    parseStatistics (stats, timings, transfers, options) {
        ...
        // To print the no. of skipped assertions
        stats.skippedAssertions && summaryTable.push([{
            colSpan: 1,
            content: colors.cyan('Skipped Assertions'),
            hAlign: 'right' },
        {
            colSpan: 1,
            content: format('%s',
                stats.skippedAssertions.total !== 0 ?
                    colors.cyan(stats.skippedAssertions.total) : stats.skippedAssertions.total),
            hAlign: 'right'
        },
        {
            colSpan: 1,
